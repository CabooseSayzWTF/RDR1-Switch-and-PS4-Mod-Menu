...
void SelfOptionP2()
{
	...
	switch (getOption())
	{
	case 1: Option1: IgnoreON = !IgnoreON; if (!IgnoreON) AI_STOP_IGNORING_ACTORS(); break;
	case 2: Option2: IrishDrunk = !IrishDrunk; if (!IrishDrunk) SET_ACTOR_DRUNK(self, 0); break;
	case 3: Option3: KILL_ACTOR(self); break;
	case 4: Option4: AiControl = !AiControl; if (AiControl) { print2("Works Best With Non Story/Non MP Characters", 3000); TASK_CLEAR(self); RELEASE_ACTOR_AS_AMBIENT(self); }; if (!AiControl) { TASK_CLEAR(self); SET_ACTOR_IS_AMBIENT(self, 0); }; break;
	case 5: Option5: FlameON = !FlameON; if (FlameON) { print2("<blue>God Mode temp turned off so this works as expected", 3000); } break;
	case 6: Option6: AnimalBypassON = !AnimalBypassON; if (AnimalBypassON)print2("This makes it so you can mount animals without getting kicked off, you will need to use template files for this to work properly", 10000); break;
	}
}
...
void SP_1()
{
	...
	switch (getOption())
	{
	case 1: Option1: UnlockMostOutfits(); break;
...
void WepMenu2()
{
	...
	add_option("Cycle Special Weaps");
	switch (getOption())
	{
	case 1: Option1: CLEAR_LAST_ATTACK(self); ExplosiveRounds = 0; DeleteGun = 0; BurnGun = 0; CopyGun = !CopyGun; break;
	case 2: Option2: Phos = 0; _ENABLE_PHOSPHORUS_ROUNDS(0); Fireround = !Fireround; if (!Fireround)FIRE_SET_GUNS_BLAZING_ACTIVE(0); break;
	case 3: Option3: Fireround = 0; FIRE_SET_GUNS_BLAZING_ACTIVE(0); Phos = !Phos; if (!Phos)_ENABLE_PHOSPHORUS_ROUNDS(0); break;
	case 4: Option4: Slugz = !Slugz; if (!Slugz)_DLC_SHOTGUN_SPREAD_OVERRIDE(self, 0, 0.1f); break;
	case 5: Option5: aimbott = !aimbott; if (aimbott) { print2("<blue>Just Aim At Somebody", 2000); }; break;
	case 6: Option6: aimbott2 = !aimbott2; break;
	case 7: Option7: SetTargetMode(); break;
	case 8: Option8: GiveSpecialWeapon(); break;
	}
}
void Sub_Menu3()
{
...
void Sub_Menu4()
{
	...
	case 3: Option3: TODLoop = 0; Timez = !Timez; if (!Timez)SET_TIME_ACCELERATION(1097859072); break;
...
void PedChanger()
{
	...
	case 6: Option6: PedWepz = 42; ToggleSpoof13 = true; break;
	case 7: Option7: SetStatArrayValue(170, GET_ACTOR_ENUM(self)); break;
	case 8: Option8: DefautSavedModel = GetStatArrayValue(170); WAIT(1000); if (DefautSavedModel > 1294 || DefautSavedModel == -1)print2("<red>Error", 2000); if(DefautSavedModel >= 0 && DefautSavedModel <= 1294)ChangeModel(self, DefautSavedModel); break;
	}
}
