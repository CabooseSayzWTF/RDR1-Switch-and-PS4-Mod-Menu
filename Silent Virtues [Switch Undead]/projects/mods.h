...
void MainLRSwitches()
{
	if (ToggleSpoof13)
	{
		...
		{
			//didnt test this much but didn't seem to do anything, will verify again later
			//stradd_s(modmsg, "Test\n<x>:Confirm\n<cancel>:Cancel\n<dpadleftright>:Blah<orange> ");
			//stradd_s(modmsg, "Vehicle Component Editor\n<x>:Enable\n<y>:Disable\n<action>:Cancel\n<dpadleftright>:Component ID:<orange> ");
			//stradd_s(modmsg, INT_TO_STRING(meshtester));
			//stradd_s(modmsg, "\n");
